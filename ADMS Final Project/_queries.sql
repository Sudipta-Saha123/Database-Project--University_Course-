...
CREATE SEQUENCE my_se START WITH 1;


INSERT INTO manager VALUES (mgr_seq.nextval, 'Shamim Ahmed', 'shamim@gmail.com', '123' , '0123404239');
INSERT INTO manager VALUES (mgr_seq.nextval, 'Shakil Ahmed', 'shakil@gmail.com', '123' , '0123404239');
INSERT INTO manager VALUES (mgr_seq.nextval, 'Dipto Roy', 'shamim123@gmail.com', '123' , '0123404239');
INSERT INTO manager VALUES (mgr_seq.nextval, 'Shamim Khan', 'khan@gmail.com', '123' , '0123404239');
...
INSERT INTO passenger VALUES (pass_seq.nextval, 'Shamim', 'shamim123', 'shamim@gmail.com', '123123123', 1);
...
INSERT INTO ticket VALUES (ticket_seq.nextval, 6, 'Available', 8);
INSERT INTO ticket VALUES (ticket_seq.nextval, 5, 'Booked', 3);
INSERT INTO ticket VALUES (ticket_seq.nextval, 2, 'Available', 10);
INSERT INTO ticket VALUES (ticket_seq.nextval, 3, 'Available', 11);
...
INSERT INTO book VALUES (book_seq.nextval, 12, 2);
INSERT INTO book VALUES (book_seq.nextval, 1, 2);
...
-- 2. Find the number of manager based on their salary
select mgr_salary, count(*) from manager group by mgr_salary;

-- 3. Retrieve the passenger ID, name, email, manager name, and manager email for any specific passenger by his/her name from the passenger and manager tables.
...
-- 4. Find of all managers who have managed a schedule with a cost greater than $1000
